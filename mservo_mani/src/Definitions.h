...
//Object Index
    const unsigned short INDEX_DIO_CONFIGURATION            = 0x3142;
...
//Object subIndex
    ...
    const unsigned char SUB_INDEX_DIO_CONFIGURATION_1       = 0x01;
    const unsigned char SUB_INDEX_DIO_CONFIGURATION_2       = 0x02;
...
//Number of Bytes to Write
    ...
    unsigned int NB_OF_BYTES_TO_WRITE_2               = 2;
    unsigned int NB_OF_BYTES_TO_WRITE_4               = 4;

//Configuration of Digital Inputs
    unsigned char NEGATIVE_LIMIT_SWITCH               = 0;
    unsigned char POSITIVE_LIMIT_SWITCH               = 1;
    unsigned char HOME_SWITCH                         = 2;
    unsigned char GENRERAL_PURPOSE_A                  = 16;
    unsigned char GENRERAL_PURPOSE_B                  = 17;
    unsigned char GENRERAL_PURPOSE_C                  = 18;
    unsigned char GENRERAL_PURPOSE_D                  = 19;
    unsigned char GENRERAL_PURPOSE_E                  = 20;
    unsigned char GENRERAL_PURPOSE_F                  = 21;
    unsigned char GENRERAL_PURPOSE_G                  = 22;
    unsigned char GENRERAL_PURPOSE_H                  = 23;
    unsigned char POSITIVE_LIMIT_SWITCH_WO_ERRORS     = 24;
    unsigned char NEGATIVE_LIMIT_SWITCH_WO_ERRORS     = 25;
    unsigned char DRIVE_ENABLE                        = 27;
    unsigned char QUICK_STOP                          = 28;
    unsigned char NONE                                = 255;
